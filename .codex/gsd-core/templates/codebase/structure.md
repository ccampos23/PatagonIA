...
- Usage: Reference from command with `@/home/pingu/Projects/PatagonIA/.codex/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/pingu/Projects/PatagonIA/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/pingu/Projects/PatagonIA/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
