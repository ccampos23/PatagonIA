...
```bash
INIT=$(node "/home/pingu/Projects/PatagonIA/.codex/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/pingu/Projects/PatagonIA/.codex/gsd-core/templates/spec.md.
