...
INSTALL_JS_GLOBAL="/home/pingu/Projects/PatagonIA/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/pingu/Projects/PatagonIA/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
