...
@/home/pingu/Projects/PatagonIA/.opencode/gsd-core/references/thinking-models-research.md
...
```bash
node "/home/pingu/Projects/PatagonIA/.opencode/gsd-core/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
