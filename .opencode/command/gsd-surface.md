...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/pingu/Projects/PatagonIA/.opencode/.gsd-surface.json`
(sibling to `/home/pingu/Projects/PatagonIA/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/pingu/Projects/PatagonIA/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/home/pingu/Projects/PatagonIA/.opencode/skills`).
...
`/home/pingu/Projects/PatagonIA/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/pingu/Projects/PatagonIA/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/pingu/Projects/PatagonIA/.opencode/.gsd-surface.json`
Install profile marker: `/home/pingu/Projects/PatagonIA/.opencode/.gsd-profile`
Skill dirs: `/home/pingu/Projects/PatagonIA/.opencode/skills/gsd-*/`
Engine module: `/home/pingu/Projects/PatagonIA/.opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/pingu/Projects/PatagonIA/.opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
