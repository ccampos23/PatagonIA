...
- Usage: Reference from command with `@/home/pingu/Projects/PatagonIA/.opencode/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/pingu/Projects/PatagonIA/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/pingu/Projects/PatagonIA/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
