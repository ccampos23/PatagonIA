...
```bash
INIT=$(node "/home/pingu/Projects/PatagonIA/.opencode/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/pingu/Projects/PatagonIA/.opencode/gsd-core/bin/gsd-tools.cjs" commit \
