...
- **Global scope**: `/home/pingu/Projects/PatagonIA/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/pingu/Projects/PatagonIA/.opencode/notes/`)
...
2. Glob `/home/pingu/Projects/PatagonIA/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/pingu/Projects/PatagonIA/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/pingu/Projects/PatagonIA/.opencode/notes/` — works in any directory
