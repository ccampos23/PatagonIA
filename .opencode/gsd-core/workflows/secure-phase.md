...
```
Agent(
  prompt="Read /home/pingu/Projects/PatagonIA/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/pingu/Projects/PatagonIA/.opencode/gsd-core/templates/SECURITY.md`
