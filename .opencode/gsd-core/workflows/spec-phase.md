...
```bash
INIT=$(node "/home/pingu/Projects/PatagonIA/.opencode/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/pingu/Projects/PatagonIA/.opencode/gsd-core/templates/spec.md.
